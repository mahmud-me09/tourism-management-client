	...
	return (
		...
		>
			<div className="relative">
				...
				<p className="text-xs md:text-2xl absolute font-bold z-30 top-0 right-0 bg-orange-50 bg-opacity-70 w-1/2 text-orange p-4 border text-black border-orange-500">
